...
func (mc *MemberCreate) SetSex(s string) *MemberCreate {
...
func (mc *MemberCreate) SetEmergencycontactID(id int) *MemberCreate {
	mc.mutation.SetEmergencycontactID(id)
	return mc
}
...
func (mc *MemberCreate) SetNillableEmergencycontactID(id *int) *MemberCreate {
	if id != nil {
		mc = mc.SetEmergencycontactID(*id)
	}
	return mc
}

// SetEmergencycontact sets the "emergencycontact" edge to the EmergencyContact entity.
func (mc *MemberCreate) SetEmergencycontact(e *EmergencyContact) *MemberCreate {
	return mc.SetEmergencycontactID(e.ID)
}
...
func (mc *MemberCreate) check() error {
	...
	if _, ok := mc.mutation.Sex(); !ok {
		return &ValidationError{Name: "sex", err: errors.New(`ent: missing required field "Member.sex"`)}
	}
...
func (mc *MemberCreate) createSpec() (*Member, *sqlgraph.CreateSpec) {
	...
	if nodes := mc.mutation.EmergencycontactIDs(); len(nodes) > 0 {
